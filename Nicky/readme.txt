...
* Updated Plugin URI to https://wordpress.org/plugins/nicky-me
...
= 1.11 =
* Added custom plugin icon for WordPress.org Plugin Directory

= 1.10 =
* Initial release on WordPress.org Plugin Directory
* Removed development and debug files from distribution package
