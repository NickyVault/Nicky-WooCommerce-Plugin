...
rm -f "$BUILD_DIR/$PLUGIN_DIR/includes/status-checker.php"
rm -f "$BUILD_DIR/$PLUGIN_DIR/README-v1.1.md"
rm -f "$BUILD_DIR/$PLUGIN_DIR/README.md"
rm -f "$BUILD_DIR/$PLUGIN_DIR/docker-compose.yml"
rm -f "$BUILD_DIR/$PLUGIN_DIR/nicky-me-safe.php"
rm -f "$BUILD_DIR/$PLUGIN_DIR/assets/js/blocks-simple-fixed.js"
rm -f "$BUILD_DIR/$PLUGIN_DIR/assets/images/logo.svg"
rm -f "$BUILD_DIR/$PLUGIN_DIR/languages/README.md"
...
echo -e "  - includes/status-checker.php"
echo -e "  - nicky-me-safe.php"
echo -e "  - README.md / README-v1.1.md"
echo -e "  - docker-compose.yml"
echo -e "  - assets/js/blocks-simple-fixed.js"
echo -e "  - assets/images/logo.svg"
echo -e "  - languages/README.md"
